...
```<link rel="stylesheet" type="text/css" href="https://unpkg.com/skeletonic@1.1.8/dist/skeletonic.min.css" />```
...
| CDN | URL | HTTPS | Combo |
|---|---|---|---|
| [unpkg](https://unpkg.com/) | https://unpkg.com/skeletonic@1.1.8/dist/skeletonic.min.css | Yes | No |
