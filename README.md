...
<p align="center"><a href="https://github.com/reedia/skeletonic/archive/v1.0.33.zip">Download Skeletonic CSS</a></p>
...
-   Download the latest [release](https://github.com/reedia/skeletonic/archive/v1.0.33.zip)
...
```
Skeletonic/
├── skeletonic-1.0.33.css
├── skeletonic.min-1.0.33.css
├── skeletonic-pattern-1.0.33.css
├── skeletonic-pattern.min-1.0.33.css
```
...
```
<link rel="stylesheet" type="text/css" href="skeletonic-pattern.min-1.0.33.css" />
<link rel="stylesheet" type="text/css" href="skeletonic.min-1.0.33.css" />
```

We offer production-ready versions and use unpkg as our CDN to link to the latest version of Skeletonic:
