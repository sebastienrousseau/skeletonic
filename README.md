...
<p align="center"><a href="https://github.com/reedia/skeletonic/archive/v1.0.59.zip">Download Skeletonic CSS</a></p>
...
-   Download the latest [release](https://github.com/reedia/skeletonic/archive/v1.0.59.zip)
...
```
Skeletonic/
├── skeletonic-1.0.59.css
├── skeletonic.min-1.0.59.css
├── skeletonic-colours-1.0.59.css
├── skeletonic-colours.min-1.0.59.css
├── skeletonic-pattern-1.0.59.css
├── skeletonic-pattern.min-1.0.59.css
```
...
```
<link rel="stylesheet" type="text/css" href="skeletonic.min-1.0.59.css" />
```

#### CSS Responsive Grid-View
```
<link rel="stylesheet" type="text/css" href="skeletonic-pattern.min-1.0.59.css" />
```

#### CSS Colours
```
<link rel="stylesheet" type="text/css" href="skeletonic-colours.min-1.0.59.css" />
```
...
| CDN | URL | HTTPS | Combo |
|---|---|---|---|
| [unpkg](https://unpkg.com/) | https://unpkg.com/skeletonic@1.0.59/dist/skeletonic.min-1.0.59.css | Yes | No |
|  [jsDelivr](https://www.jsdelivr.com/) | https://cdn.jsdelivr.net/npm/skeletonic/dist/skeletonic.min-1.0.59.css  | Yes | Yes |
| [RawGit](http://rawgit.com/) | https://cdn.rawgit.com/reedia/skeletonic/cd0aca0e/dist/skeletonic.min-1.0.59.css | Yes | No |
